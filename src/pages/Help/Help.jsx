...
const Help = () => {
  return (
    <div className="container-lg">
      <h3 className="h2 fw-900 black">Help</h3>
      <h4 className="h4 fw-900 black">H1 Schedule Method</h4>
      <CardLargeAlt>
        <h5 className="body fw-800 bright-blue">General Info</h5>
      ...
      <h4 className="h4 fw-900 light-black">Moisture Risk Matrix</h4>
      <CardLargeAlt>
        <h5 className="body fw-800 bright-blue">General Info</h5>
        <p className="body dark-gray">
      ...
      <h4 className="h4 fw-900 black">Additional Calculators</h4>
      <CardLargeAlt>
        <h5 className="body fw-800 bright-blue">General Info</h5>
        <p className="body dark-gray">
          • All input fields only require numeric values.
