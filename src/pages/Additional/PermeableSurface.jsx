...
const PermeableSurface = () => {
    ...
    return(
        <div>
            <h4 className="h5 blue fw-700 pl-20">Permeable Surface</h4>
            <CardSmallalt>
                <table className="table-sm" onChange={PermeableHandler}>
                  <tbody>
                    ...
                    <tr className="table-row">
                        <td><p className="body-bold fw-700">Total Impervious</p></td>
                        <td><h5 className="result-text_sm dt-blue ml-0 fw-700 text-center " id="permeableResultOne">{areaImperv}m²</h5></td>
                    </tr>

                    <tr className="table-row">
                        <td><p className="body-bold fw-700">Total Permeable</p></td>
