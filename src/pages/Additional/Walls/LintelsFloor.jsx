...
const LintelsFloor = () => {
    ...
    return (
        <div>
            <h4 className="h5 pl-10 fw-900 black">Lintels Supporting Floor Only SG8</h4>
            <CardSmallalt>
                <div onChange={lintelSizeHandler}>
                    <div className="flex-row mb-20">
                        <p className="body black">Max Loaded Dimenion of Lintel (m)</p>
                        <select className="select-md select-width label dark-gray" id="loadedDimension5">
                ...
                <div className="mb-20 mt-30 flex-row">
                    ...
                    <h5 className="h5-0mg fw-900 bright-blue mb-10">{lintelFloorSize}</h5>
                </div>
