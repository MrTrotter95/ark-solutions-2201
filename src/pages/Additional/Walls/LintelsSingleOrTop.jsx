...
const LintelSingleOrTop = () => {
    ...
    return (
        <div>
            <h4 className="h5 pl-10 fw-900 black">Lintels Supporting Roof Only SG8</h4>
            <CardSmallalt>
                <div onChange={lintelSizeHandler}>
                    <div className="flex-row mb-20">
                        <p className="body black">Roof Weight</p>
                        <select className="select-md select-width label dark-gray" id="roofWeight">
                    ...
                    <div className="flex-row mb-20">
                        ...
                        <select className="select-md select-width label dark-gray" id="loadedDimension">
                ...
                <div className="mb-20 mt-30 flex-row">
                    ...
                    <h5 className="h5-0mg fw-900 bright-blue mb-10">{lintelSize}</h5>
                </div>
