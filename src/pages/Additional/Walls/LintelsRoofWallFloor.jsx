...
const LintelsRoofWallFloor = () => {
    ...
    return (
        <div>
            <h4 className="h5 pl-10 fw-900 black" style={{width: 320}}>Lintels Supporting Roof, Wall & Floor SG8</h4>
            <CardSmallalt>
                <div onChange={lintelSizeHandler}>
                    <div className="flex-row mb-20">
                        <p className="body black">Roof & Wall Weight</p>
                        <select className="select-md label dark-gray select-overflow select-height" id="roofWallWeight3" style={{width: 140}}>
                    ...
                    <div className="flex-row mb-20">
                        ...
                        <select className="select-md label dark-gray" id="loadedDimension3">
                ...
                <div className="mb-20 mt-30 flex-row">
                    ...
                    <h5 className="h5-0mg fw-900 bright-blue mb-10">{lintelRoofWallFloorSize}</h5>
                </div>
