...
const LintelsRoofWallFloor = () => {
    ...
    return (
        <div>
            <h4 className="h5 pl-10 blue fw-700" style={{width: 320}}>Lintels Supporting Roof, Wall & Floor SG8</h4>
            <CardSmallalt>
                <div onChange={lintelSizeHandler}>
                    <div className="flex-row mb-20">
                        <p className="body dark-gray">Roof & Wall Weight</p>
                        <select className="select-md label select-overflow select-height" id="roofWallWeight3">
                ...
                <div className="mb-20 mt-30 flex">
                    ...
                    <h5 className="result-text_md blue fw-800  mb-10">{lintelRoofWallFloorSize}</h5>
                </div>
