...
const ConnectionToPost = () => {
    return (
        <div>
            <h4 className="h5 pl-10 fw-900 black">Connections To Posts & Beams(kN)</h4>
            <CardSmallalt>
                ...
                <div className="mb-20 mt-30">
                    <h5 className="h5-0mg fw-900 black mb-10">Capacity of post and beam connections: <span className="h5-0mg fw-900 bright-blue mb-10">7.9 kN</span> </h5>
                </div>
            </CardSmallalt>
        </div>
    )
