...
const WindowRowTwo = (props) => {
    ...
    return (
        <tr className="table-data-1">
            ...
            <td><h5 className="text-center result-text_md blue rowAreaResult" id="rowArea">{windowArea}</h5></td>
        </tr>
    )
}

export default WindowRowTwo;