...
const About = () => {
    return(
        <div className="container-lg">
            <h3 className="h2 fw-900 black">About The Project</h3>
            ...
            <h3 className="h2 fw-900 black">Why Are These Valuable?</h3>
            <CardLargeAlt>
                ...
                <h5 className="h5 fw-900 light-black">How it's calculated</h5>
            ...
            <CardLargeAlt>
                <h4 className="h4-0mg fw-900 light-black">Risk Matrix</h4>
                ...
                <h5 className="h5 fw-900 light-black">How it helps</h5>
                <ol className="body dark-gray mb-20">
                ...
                <h5 className="h5 fw-900 light-black">The Rules</h5>
            ...
            <CardLargeAlt>
                <h4 className="h4-0mg fw-900 light-black">Wind Zone</h4>
            ...
            <CardLargeAlt>
                <h4 className="h4-0mg fw-900 light-black">Council</h4>
