...
const About = () => {
    return(
        <div className="container-lg">
            <h3 className="h2 dt-white fw-900">About The Project</h3>

            <CardLargeAlt>
            <h4 className="h4-0mg dt-blue fw-800">The Approach & Purpose</h4>
            <p className="body dt-gray">To provide the Architectural industry in Aotearoa with efficient, easy to use digital solutions to assist them
            ...
            <p className="body dt-gray">• Implementing React Router.</p>
            <p className="body dt-gray">• A higher quality solution to the "helper images" used on the wind zone and risk matrix calculator, including
            allowing it to be mobile responsible.</p>
            <p className="body dt-gray">• Complete the design and build of the "print to pdf" functionality.</p>
            <p className="body dt-gray">• A responsive navbar.</p>
            <p className="body dt-gray">• As programming is a learning journery I plan on going back to revise and improve the code of older and previously completed calculators such as Schedule Method and the Risk Matrix.</p>
            </CardLargeAlt>


            <h3 className="h2 fw-900 dt-white">Why Are These Valuable?</h3>
            <CardLargeAlt>
                <h4 className="h4-0mg dt-blue fw-800">H1 Schedule Method</h4>
                <p className="body dt-gray mb-20">For residential housing compliance a H1 Schedule Method calculation is required for all residential housing consents.
                ...
                <h5 className="subtitle dt-white fw-600">How it's used</h5>
                <ol className="body dt-gray mb-20">
                ...
                <h5 className="subtitle dt-white fw-600">How it's calculated</h5>
                <ol className="body dt-gray">
            ...
            <CardLargeAlt>
                ...
                <p className="body dt-gray">A Risk Matrix calculation in short determines the weathertightness risk of the proposed house design.</p>
                <p className="body dt-gray mb-20">By completing the weathertightness calculation you can quickly
                ...
                <h5 className="subtitle dt-white fw-600">How it helps</h5>
                <ol className="body dt-gray mb-20">
                ...
                <h5 className="subtitle dt-white fw-600">The Rules</h5>
                <ul className="body dt-gray">
            ...
            <CardLargeAlt>
                ...
                <p className="body dt-gray">Wind direction, speed and frequency will influence the building design including bracing requirements, roof 
            ...
            <CardLargeAlt>
                ...
                <p className="body dt-gray">To be a central hub for frequently used resoures that workers in the industry used such as links to submitting a 
